...
```sh
--packages com.banzaicloud:spark-metrics_2.11:2.3-1.1.0,io.prometheus:simpleclient:0.3.0,io.prometheus:simpleclient_dropwizard:0.3.0,io.prometheus:simpleclient_pushgateway:0.3.0,io.dropwizard.metrics:metrics-core:3.1.2
```
...
1. downloading and adding the following jars to `assembly/target/scala-2.11/jars`:
   1. com.banzaicloud:spark-metrics_2.11:2.3-1.1.0
